...
//    };
    this.modelDef = {
        ...
        "motions":[
            "assets/haru/motions/shake_00.mtn",
        ]
    };
...
//        live2DModel.setMatrix(matrix4x4);
    ...
    // サイズ(幅)
    mmat.setWidth(scale.value);
    // ポジション(X, Y)
    mmat.setCenterPosition(posX.value, posY.value);
    // 配列をセット
...
//    live2DModel.setParamFloat("PARAM_ANGLE_X", L2D_X.value);
//    live2DModel.setParamFloat("PARAM_ANGLE_Y", L2D_Y.value);
